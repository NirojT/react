...
const UpdateNotice = () => {
  ...
  const getNoticeById = useNoticesStore((state: any) => state.getNoticeById);
  ...
  const updateNotice = useNoticesStore((state: any) => state.updateNotice);
  // states
  ...
  const handleSubmitClick = (
    ...
    e.preventDefault();
    setLoading(true);
    // let updateId: number = (id && parseInt(id)) || 0;
    if (id)
      noticeClass.updateNotice(
        id,
        noticeData,
        updateNotice,
        setLoading,
              ...
              <div className="flex flex-col gap-y-3">
                ...
                <div className="flex flex-col gap-y-1">
                  ...
                  <input
                    ...
                    name="date-time"
                    id="date-time"
                    value={new Date(`${noticeData.noticeDate}`)
                      .toISOString()
                      .slice(0, 16)}
                    onChange={(e) => {
